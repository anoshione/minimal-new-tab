...
const isSidebarLeft = settings.sidebarPosition === "left";
document.body.classList.toggle("sidebar-left", isSidebarLeft);
document.body.classList.toggle("sidebar-right", !isSidebarLeft);
